...
const temples = [
  ...
  area: 17500,
  imageUrl:
    "https://upload.wikimedia.org/wikipedia/commons/7/7c/Accra_Ghana_Temple.jpg"
},
{
  ...
  area: 19860,
  imageUrl:
    "https://upload.wikimedia.org/wikipedia/commons/0/0f/Durban_South_Africa_Temple.jpg"
}
...
function displayTemples(templeList) {
  ...
  templeList.forEach(temple => {
    ...
    img.onerror = () => {
      img.src = "https://via.placeholder.com/400x250?text=Temple+Image";
    };
